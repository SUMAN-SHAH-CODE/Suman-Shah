  ...
  template: `
    <nav class="navbar glass-panel">
      <div class="nav-container container-custom">
        ...
        <a routerLink="/" class="brand-logo">
          ...
          <span class="logo-text"
            >Er. <span class="highlight"> SUMAN SHAH</span></span
          >
        </a>
        ...
        <div class="nav-links">
          ...
          <a
            ...
            >Experience</a
          >
          <a routerLink="/blogs" routerLinkActive="active" class="nav-item"
            >Blogs</a
          >
      ...
      <div class="mobile-drawer" [class.show]="mobileMenuOpen">
        ...
        >
        <ng-container
          *ngIf="authService.currentUser$ | async; else mobileLogin"
        >
        ...
        <ng-template #mobileLogin>
          <a routerLink="/admin/login" (click)="closeMobileMenu()"
            >Admin Portal Login</a
          >
        </ng-template>
      </div>
    </nav>
