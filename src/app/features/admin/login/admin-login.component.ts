    ...
    <div class="container-custom login-wrapper">
      <div class="login-card glass-panel">
        <div class="login-header">
          ...
          <p>Authenticate to manage database posts, blogs, achievements, and portfolio assets.</p>
        </div>
        ...
        <button (click)="loginAsDemoAdmin()" [disabled]="loading" class="btn-cinematic btn-block quick-btn">
        ...
        <form (ngSubmit)="loginWithPassword()" class="login-form">
          ...
          <div class="credentials-hint">
            <span>Demo: <code>admin&#64;cinematic-portfolio.com</code> / <code>admin123</code></span>
          </div>

          <div class="form-actions">
            <button type="submit" [disabled]="loading" class="btn-cinematic btn-outline btn-block">
